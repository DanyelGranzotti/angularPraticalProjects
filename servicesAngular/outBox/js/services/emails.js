  ...
  function ($http) {
    ...
    return (
      $http
        ...
        .get(
          "https://content.codecademy.com/courses/ltp4/emails-api/emails.json?_gl=1*1kssmvy*_ga*MTEyMzc2NzQyNS4xNjM5MzMwNjQ1*_ga_3LRZM6TM9L*MTY1MjY3MDg2My4zMi4xLjE2NTI2NzIzODcuNDc."
        )
