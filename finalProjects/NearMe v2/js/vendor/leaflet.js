  ...
  (o.version = "0.7.1"),
    ...
    (function () {
      ...
      (o.Util.requestAnimFrame = function (e, n, a, r) {
        return (
          (e = o.bind(e, n)), a && s === i ? (e(), void 0) : s.call(t, e, r)
        );
      }),
  ...
  o.Marker.include(a),
    ...
    (o.DomEvent = {
      ...
      getMousePosition: function (t, i) {
        var n = e.body,
          s = e.documentElement,
          a = o.DomUtil.documentIsLtr()
            ? t.pageX
              ? t.pageX - n.scrollLeft - s.scrollLeft
              : t.clientX
            : o.Browser.gecko
            ? t.pageX - n.scrollLeft - s.scrollLeft
            : t.pageX
    ...
    (o.PosAnimation = o.Class.extend({
      ...
      _onStep: function () {
        var t = this._getPos();
        return t
          ? ((this._el._leaflet_pos = t), this.fire("step"), void 0)
