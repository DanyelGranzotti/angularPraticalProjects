...
(function (Q, W, t) {
  ...
  function Da(b, a, c, d) {
    ...
    if (a) {
      ...
      H(b)
        ...
        : J(b) &&
          ((e = Object.create(Object.getPrototypeOf(b))), (a = Da(b, e, c, d)));
    return a;
  }
  function sa(b, a) {
    if (H(b)) {
  ...
  function uc(b, a, c) {
    ...
    Q &&
      e.test(Q.name) &&
      ((c.debugInfoEnabled = !0), (Q.name = Q.name.replace(e, "")));
  ...
  function xb(b, a) {
    ...
    d &&
      (a
        ? delete d.data[a]
        : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), Jc(b)),
          delete zb[c],
          (b.ng339 = t)));
  }
  function yb(b, a) {
    ...
    a &&
      !c &&
      ((b.ng339 = c = ++hf), (c = zb[c] = { events: {}, data: {}, handle: t }));
    return c;
  }
  function Vb(b, a, c) {
    if (Gc(b)) {
          ...
          ? (g || (P = a),
            c
              ...
              ? ((c = q),
                ...
                (c.hash = a))
              : (q.href = a))
          : (u[c ? "replaceState" : "pushState"](e, "", a), h(), (I = B));
        return n;
      }
      ...
      function (a, b, c, s, M, v, m, F, Z, L, B) {
        ...
        function D(a, b, c, d, e) {
          ...
          return function (b, c, d) {
            ...
            g ||
              (g = (d = d && d[0])
                ? "foreignobject" !== va(d) && d.toString().match(/SVG/)
                  ? "svg"
                  : "html"
                : "html");
            d =
              "html" !== g
                ? A(Xb(g, A("<div>").append(a).html()))
                : c
                ? Ka.clone.call(a)
                : a;
            if (h)
        ...
        function S(a, b, c, d, e, f) {
          function g(a, c, d, e) {
            ...
            for (p = h.length; q < p; )
              (k = M[h[q++]]),
                ...
                c
                  ? (c.scope
                      ? ((l = a.$new()), D.$$addScopeInfo(A(k), l))
                      : (l = a),
                    (s = c.transcludeOnThisElement
                      ? P(a, c.transclude, e, c.elementTranscludeOnThisElement)
          ...
          for (var h = [], k, l, q, p, m, s = 0; s < a.length; s++) {
            ...
            (f = l.length ? fa(l, a[s], k, b, c, null, [], [], f) : null) &&
              f.scope &&
              D.$$addScopeClass(k.$$element);
            k =
              (f && f.terminal) || !(q = a[s].childNodes) || !q.length
                ? null
                : S(
                    q,
                    f
        ...
        function X(a, b, c, d, g) {
          ...
          switch (a.nodeType) {
            case qa:
              ka(b, xa(va(a)), "E", d, g);
              for (
                var l, q, p, m = a.attributes, s = 0, M = m && m.length;
                s < M;
                s++
              ) {
                var u = !1,
        ...
        function fa(a, d, e, f, g, k, l, p, m) {
          ...
          function B(a, c, f, g, h) {
            ...
            if (P) {
              D.$$addScopeInfo(
                ...
                I,
                !0,
                !(ma && (ma === P || ma === P.$$originalDirective))
              );
              D.$$addScopeClass(X, !0);
              g = Z && Z[P.name];
              var ba = I;
                ...
                switch (a.mode) {
                  ...
                  case "=":
                    ...
                    f = a.collection
                      ...
                      : c.$watch(M(O[e], f), null, h.literal);
                    I.$on("$destroy", f);
                    break;
                  case "&":
                    (h = M(O[e])),
            ...
            for (m = l.length; g < m; g++)
              (s = l[g]),
                $(
                  ...
                  X,
                  O,
                  s.require && L(s.directiveName, s.require, X, F),
                  gb
                );
            var Wb = c;
          ...
          for (
            ...
            if ((V = K.scope))
              K.templateUrl ||
                (J(V)
                  ? (Na("new/isolated scope", P || F, K, w), (P = K))
                  : Na("new/isolated scope", P, K, w)),
                (F = F || K);
            da = K.name;
            !K.templateUrl &&
              K.controller &&
            ...
            if (K.template)
              if (
                ...
                Na("template", ma, K, w),
                (ma = K),
                (V = G(K.template) ? K.template(w, e) : K.template),
                (V = Tc(V)),
                K.replace)
              ) {
                k = K;
        ...
        function of(a, b, c, d, e, f, g, h) {
          ...
          return function (a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (k
                ? k.push(b, c, d, a)
                : (l.transcludeOnThisElement && (a = P(b, l.transclude, e)),
                  l(q, b, c, d, a)));
          };
        }
        function da(a, b) {
        ...
        return function (g, h, l, k) {
          ...
          if (C(g)) {
            ...
            g = b.hasOwnProperty(p)
              ? b[p]
              : xc(h.$scope, p, !0) || (a ? xc(e, p, !0) : t);
            sb(g, p, !0);
          }
          if (l)
            return (
              (l = (H(g) ? g[g.length - 1] : g).prototype),
  ...
  function Ke() {
    var b = (this.defaults = {
        ...
        transformRequest: [
          function (a) {
            return J(a) &&
              "[object File]" !== Ca.call(a) &&
              "[object Blob]" !== Ca.call(a) &&
              "[object FormData]" !== Ca.call(a)
              ? $a(a)
              : a;
          },
        ],
      ...
      function (d, e, f, g, h, l) {
        ...
        function n(c, f) {
          function l(b, c, d, e) {
            ...
            I &&
              (200 <= b && 300 > b ? I.put(P, [b, c, Xc(d), e]) : I.remove(P));
          ...
          (!c.cache && !b.cache) ||
            ...
            (I = J(c.cache) ? c.cache : J(b.cache) ? b.cache : q);
          I &&
            ((D = I.get(P)),
            y(D)
              ? D && G(D.then)
                ? D.then(n, n)
                : H(D)
                ? m(D[1], D[0], sa(D[2]), D[3])
                : m(D, 200, {}, "OK")
              : I.put(P, B));
          x(D) &&
            ((D = $c(c.url)
              ? e.cookies()[c.xsrfCookieName || b.xsrfCookieName]
              : t) && (S[c.xsrfHeaderName || b.xsrfHeaderName] = D),
            d(
              c.method,
              P,
              f,
  ...
  function wf(b, a, c, d, e) {
    ...
    return function (e, h, l, k, n, p, q, u) {
      ...
      if ("jsonp" == z(e)) {
        ...
        var m = f(
          h.replace("JSON_CALLBACK", "angular.callbacks." + v),
          v,
          function (a, b) {
            M(k, a, d[v].data, "", b);
            d[v] = E;
    ...
    this.$get = [
      ...
      function (c, d, e) {
        ...
        function g(f, g, u, s) {
          ...
          s = !!s;
          for (
            var m, F, r = 0, L = [], B = [], I = f.length, D = [], S = [];
            r < I;

          )
            if (-1 != (m = f.indexOf(b, r)) && -1 != (F = f.indexOf(a, m + h)))
              r !== m && D.push(M(f.substring(r, m))),
                (r = f.substring(m + h, F)),
                L.push(r),
                B.push(c(r, v)),
                (r = F + l),
      ...
      function (b, a, c, d) {
        function e(e, h, l, k) {
          ...
          M.$$intervalId = n(function () {
            ...
            0 < l &&
              q >= l &&
              (s.resolve(q), p(M.$$intervalId), delete f[M.$$intervalId]);
            u || b.$apply();
          }, h);
          f[M.$$intervalId] = s;
          return M;
          ...
          switch (typeof d) {
            case "string":
              ...
              m ||
                ...
                (g = g ? u : q),
                (m = new hc(g)),
                (m = new ib(m, c, g).parse(d)),
                m.constant
                  ? (m.$$watchDelegate = n)
                  : r
                  ? ((m = e(m)), (m.$$watchDelegate = m.literal ? k : l))
                  : m.inputs && (m.$$watchDelegate = h),
                (L[t] = m));
              return p(m, f);
            case "function":
              return p(d, f);
      ...
      function (f, g, h, l) {
        ...
        n.prototype = {
          ...
          $watch: function (a, b, c) {
            ...
            var f = this.$$watchers,
              g = { fn: b, last: u, get: e, exp: a, eq: !!c };
            d = null;
            G(b) || (g.fn = E);
            f || (f = this.$$watchers = []);
            f.unshift(g);
  ...
  function Ue() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = aa(
            (/android (\d+)/.exec(z((b.navigator || {}).userAgent)) || [])[1]
          ),
        ...
        if (l) {
          ...
          !d ||
            (k && n) ||
            ((k = C(f.body.style.webkitTransition)),
            (n = C(f.body.style.webkitAnimation)));
        }
        return {
  ...
  var H = Array.isArray,
    ...
    bb = function () {
      ...
      var b = !(
        !W.querySelector("[ng-csp]") && !W.querySelector("[data-ng-csp]")
      );
      if (!b)
        try {
          new Function("");
  ...
  var Ka = (T.prototype = {
      ready: function (b) {
        ...
        "complete" === W.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), T(Q).on("load", a));
      },
      toString: function () {
        var b = [];
        r(this, function (a) {
  ...
  ab.$$annotate = function (a, c, d) {
    ...
    if ("function" === typeof a) {
      ...
      H(a)
        ? ((c = a.length - 1), sb(a[c], "fn"), (e = a.slice(0, c)))
        : sb(a, "fn", !0);
    return e;
  };
  var Tf = R("$animate"),
            ...
            return {
              ...
              setClass: function (a, c, d, e) {
                ...
                m
                  ? e &&
                    m.options &&
                    (m.options = ca.extend(m.options || {}, e))
        ...
        if (!c.href && !c.xlinkHref && !c.name)
          return function (a, c) {
            if ("a" === c[0].nodeName.toLowerCase()) {
              var f =
                "[object SVGAnimatedString]" === Ca.call(c.prop("href"))
                  ? "xlink:href"
                  : "href";
      ...
      return {
        ...
        link: function (d, e, f) {
          var g = a,
            h = a;
          "href" === a &&
            "[object SVGAnimatedString]" === Ca.call(e.prop("href")) &&
            ((h = "xlinkHref"), (f.$attr[h] = "xlink:href"), (g = null));
          f.$observe(c, function (c) {
            c
              ? (f.$set(h, c), Qa && g && e.prop(g, f[h]))
              : "href" === a && f.$set(h, null);
          });
        },
      };
  ...
  var yd = function (a) {
            ...
            compile: function (d, e) {
              ...
              return {
                pre: function (a, d, e, k) {
                  ...
                  var p = k.$$parentForm;
                  f &&
                    (hb(a, null, k.$name, k, k.$name),
                    e.$observe(f, function (c) {
                      k.$name !== c &&
                        (hb(a, null, k.$name, t, k.$name),
                        p.$$renameControl(k, c),
                        hb(a, null, k.$name, k, k.$name));
                    }));
                  d.on("$destroy", function () {
    ...
    Dd = {
      ...
      "datetime-local": kb(
        "datetimelocal",
        Ad,
        Mb(Ad, "yyyy MM dd HH mm ss sss".split(" ")),
    ...
    eg = [
      ...
      function (a, c, d, e, f, g, h, l, k, n) {
          ...
          if (!Y(m.$modelValue) || !isNaN(m.$modelValue)) {
            ...
            m.$$runValidators(a, m.$$lastCommittedViewValue, function (f) {
              e ||
                c === f ||
                ((m.$modelValue = f ? a : t),
                m.$modelValue !== d && m.$$writeModelToScope());
            });
          }
        };
        ...
        this.$commitViewValue = function () {
          ...
          h.cancel(M);
          if (
            m.$$lastCommittedViewValue !== a ||
            ("" === a && m.$$hasNativeValidators)
          )
            (m.$$lastCommittedViewValue = a),
        ...
        this.$$parseAndValidate = function () {
          ...
          f &&
            ((m.$modelValue = c),
            m.$modelValue !== e && m.$$writeModelToScope());
        ...
        a.$watch(function () {
          ...
          if (c !== m.$modelValue) {
            ...
            m.$viewValue !== f &&
              ((m.$viewValue = m.$$lastCommittedViewValue = f),
              m.$render(),
            ...
            this.$options.updateOn !== t
              ? ((this.$options.updateOnDefault = !1),
                (this.$options.updateOn = N(
                  this.$options.updateOn.replace(fg, function () {
          ...
          compile: function (f, g) {
            ...
            return function (a, f, g, k, n) {
              ...
              a.$watchCollection(p, function (g) {
                ...
                for (k = 0; k < G; k++)
                  if (
                    ((H = g === J ? k : J[k]), (L = g[H]), (C = z[k]), C.scope)
                  ) {
                    D = v;
                    do D = D.nextSibling;
          ...
          controller: [
            ...
            function (a, c, d) {
              ...
              l.removeOption = function (a) {
                this.hasOption(a) &&
                  (delete k[a],
                  n.$viewValue === a && this.renderUnknownOption(a));
              };
                      ...
                      (v = t[z + 1])
                        ? ((N = v.element),
                          v.label !== d.label &&
                            (n(O, v.label, !1),
                            n(O, d.label, !0),
                            N.text((v.label = d.label)),
                            N.prop("label", v.label)),
                          v.id !== d.id && N.val((v.id = d.id)),
                          N[0].selected !== d.selected &&
                            (N.prop("selected", (v.selected = d.selected)),
                            Qa && N.prop("selected", v.selected)))
                        : ("" === d.id && w
                            ? (U = w)
                            : (U = F.clone())
                                .val(d.id)
                          ...
                          n(O, d.label, !0),
                          N ? N.after(U) : s.element.append(U),
                          (N = U));
                  for (z++; t.length > z; )
